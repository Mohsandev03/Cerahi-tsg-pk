  ...
  return (
    <>
      <div className="product-detail default">
          ...
          <div className="container">
            <div className="flex   w-full">
              <div className="menu-tab flex items-center md:gap-[60px] gap-8">
                ...
                <div
                  className={`tab-item heading5 has-line-before text-secondary2 hover:text-black duration-300 ${
                    activeTab === "customer-reviews" ? "active" : ""
                  }`}
                  onClick={() => handleActiveTab("customer-reviews")}
                >
                  Custotmer Reviews
                </div>
              </div>
            ...
            <div className="desc-block mt-8">
                ...
                <div className="grid md:grid-cols-2 gap-8 gap-y-5">
                  <div className="left">
                    ...
                    <div className="text-secondary mt-2">
                      your home organized, yet elegant with storage cabinets by
                      Onita Patio Furniture. These cabinets not only make a
                      ...
                      things. Made of high quality materials, they are sturdy
                      and durable for years. Bring one-of-a-kind look to your
              ...
              <div
                className={`desc-item specifications flex   ${
              ...
              <div
                className={`desc-item specifications flex   ${
                  activeTab === "customer-reviews" ? "open" : ""
                }`}
              >
                <div className="review-block md:py-5 py-5  ">
                  <div className="container">
                      ...
                      <div className="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
                        ...
                        <div className="right lg:w-3/4 w-full lg:pl-[15px]">
                          ...
                          <div className="body1 mt-3">
                            ...
                            experience is seamless. The website is
                            user-friendly, the product images are clear, and the
                            checkout process is quick.
                          </div>
                          <div className="action mt-3">
                            <div className="flex items-center gap-4">
                              <div className="like-btn flex items-center gap-1 cursor-pointer">
                      ...
                      <div className="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
                        ...
                        <div className="right lg:w-3/4 w-full lg:pl-[15px]">
                          ...
                          <div className="body1 mt-3">
                            ...
                            fashion brand is. They prioritize eco-friendly
                            materials and fair trade practices, which makes me
        ...
        <div className="related-product md:py-5  py-5">
          <div className="container">
