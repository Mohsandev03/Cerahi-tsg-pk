  ...
  return (
    <>
      <div className="product-detail default">
            ...
            <div className="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
              ...
              <div className="list-action mt-6">
                ...
                <div className="choose-quantity flex items-center lg:justify-between gap-5 gap-y-3 mt-3">
                  <div className="quantity-block md:p-3 flex items-center justify-between rounded-lg border border-line sm:w-[180px] w-[120px]">
                    <Icon.Minus
                      size={20}
                ...
                <div className="more-infor mt-6">
                  ...
                  <div className="flex items-center gap-1 mt-3">
                    ...
                    <div className="text-secondary">4 - 5 Working Days </div>
                  </div>
                  ...
                  <div className="main-content lg:pt-8 pt-6 lg:pb-6 pb-4 sm:px-4 px-3 border border-line rounded-xl relative max-md:w-2/3 max-sm:w-full">
                    ...
                    <div className="list grid grid-cols-6">
                      {[
                        ...
                        <div
                          key={idx}
                          className="item flex items-center justify-center px-1"
                        >
                          <Image
        ...
        {/* ✅ Extra Sections (unique per product, with image slider + testimonial auto-slider) */}
        {Array.isArray(productMain.extraSections) &&
          productMain.extraSections.length > 0 && (
            <div className="mt-10 space-y-16 container">
              {productMain.extraSections.map((section, idx) => (
                <div key={idx} className="border-t pt-10">
                  {/* 🔹 TOP: Info + Image Slider */}
                  <div className="grid md:grid-cols-6 grid-cols-1 gap-6 items-center">
                    {/* LEFT: Text content */}
                    <div className="md:col-span-3 col-span-1">
                      <h3 className="text-title font-semibold mb-4 text-3xl">
                        {section.title}
                      </h3>
                      <ul className="space-y-2">
                        {section.content.map(
                          (
                            ...
                            <li
                              key={index}
                              className="flex justify-between text-sm   border-gray-200 pb-2"
                            >
                          ...
                          {section.images.map((img: string, imgIdx: number) => (
                            <SwiperSlide key={imgIdx}>
                              <Image
                                ...
                                width={1000}
                                height={100}
                                alt={`${section.title}-image-${imgIdx}`}
                  ...
                  {/* 🔹 BOTTOM: Testimonial Auto Slider (3 per row) */}
                  {Array.isArray(section.testimonials) &&
                    section.testimonials.length > 0 && (
                      <div className="mt-10">
                        <h4 className="text-md font-semibold mb-6 text-gray-800 text-2xl">
                        ...
                        >
                          {section.testimonials.map(
                            (
                              ...
                              <SwiperSlide key={tIdx}>
                                <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col justify-between">
          ...
          <div className="desc-tab md:pb-10  pt-10">
        ...
        {/* Related Products */}
        <div className="related-product  py-10">
          <div className="container">
            <div className="heading5">Related Products</div>
